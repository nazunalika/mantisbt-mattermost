...
<table class="table table-bordered table-condensed table-striped">
  ...
  <tr>
    ...
    <td colspan="2">
      <p>
        Specifies the mapping between Mantis project names and Mattermost webhooks.
      </p>
      <p>
        Option name is <strong>plugin_Mattermost_url_webhooks</strong> and is an array of 'Mantis project name' => 'Mattermost webhook'.
  ...
  <tr>
    ...
    <td colspan="2">
      <p>
        Specifies the mapping between Mantis project names and Mattermost #channels.
      </p>
      <p>
        Option name is <strong>plugin_Mattermost_channels</strong> and is an array of 'Mantis project name' => 'Mattermost channel name'.
        Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
  ...
  <tr>
    ...
    <td colspan="2">
      <p>
        Specifies the bug fields that should be attached to the Mattermost notifications.
      </p>
      <p>
        Option name is <strong>plugin_Mattermost_columns</strong> and is an array of bug column names.
        Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
        <?php
  ...
  <tr>
    ...
    <td colspan="2">
      <p>
        Specifies mapping between Mantis and Mattermost user names. This helps ensure the responsible party is properly tagged.
      </p>
      <p>
        Option name is <strong>plugin_Mattermost_usernames</strong> and is an array of 'Mantis user name' => 'Mattermost user name'.
        Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
